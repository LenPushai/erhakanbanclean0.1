...
console.log('Line 2694:', JSON.stringify(lines[2693]));
console.log('Line 2713:', JSON.stringify(lines[2712]));
...
// Splice lines 2693 to 2712 (0-indexed) = lines 2694 to 2713 (1-indexed)
lines.splice(2693, 20, ...newBlock);
fs.writeFileSync('src/App.tsx', lines.join('\n'), 'utf8');
console.log('E2 Time tab replaced OK - new line count:', lines.length);
